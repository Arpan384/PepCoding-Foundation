...
public class _22_addTwoLinkedLists {
    ...
    public static class LinkedList {
        ...
        private static int addLLHelper(Node n1, int plv1, Node n2, int plv2, LinkedList ans) {
            if (plv1 == 0 && plv2 == 0) {
                return 0;
            }

            if (plv1 > plv2) {
                int carry = addLLHelper(n1.next, plv1 - 1, n2, plv2, ans);
                int sum = carry + n1.data;
                ans.addFirst(sum % 10);
                return sum / 10;
            } else if (plv1 < plv2) {
                int carry = addLLHelper(n1, plv1, n2.next, plv2 - 1, ans);
                int sum = carry + n2.data;
                ans.addFirst(sum % 10);
                return sum / 10;
            } else {
                int carry = addLLHelper(n1.next, plv1 - 1, n2.next, plv2 - 1, ans);
        ...
        public static LinkedList addTwoLists(LinkedList one, LinkedList two) {
            ...
            int carry = addLLHelper(one.head, one.size, two.head, two.size, ans);
            if (carry == 1) {
                ans.addFirst(1);
            }
