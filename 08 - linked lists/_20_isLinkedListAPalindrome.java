...
public class _20_isLinkedListAPalindrome {
    ...
    public static class LinkedList {
        ...
        public boolean IsPalindrome() {
            ...
            return isPalin(head, head) != null ? true : false;
        }

        private Node isPalin(Node h1, Node h2) {
            // System.out.println("PRE: "+h1.data+" : "+h2.data);
            if (h2.next != null) {
                h1 = isPalin(h1, h2.next);
            }

            // System.out.println("POST: "+(h1==null? -1:h1.data)+" : "+h2.data);
            if (h1 == null)
                return null;
            if (h1.data == h2.data) {
                return h2 == head ? head : h1.next;
            } else
                return null;
